...
export type Message={id:string;ownerId:string;leadId:string;content:string;direction:"outgoing";status:"DRAFT"|"SENT"|"CANCELLED";createdAt:string;updatedAt:string};
